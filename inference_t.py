...
root_folder = "mitB1_uper_layerReversed_cat"
config_file = f"logs/{root_folder}/main.py"
ckpt_file = f"logs/{root_folder}/model_uperseg.pth"
folder = "../Dataset/val"
mask_folder = "../Dataset/val_seg_map"
image = "../Dataset/test/test/782707d7c359e27888daefee82519763.jpeg"
...
if __name__ == '__main__':
    ...
    for file in tqdm(os.listdir(folder)):
        ...
        #plt.show()
        plt.savefig(f'logs/{root_folder}/gen_masks/{name}.jpg')
        plt.close(fig)
